        ...
        <div className="max-w-screen-xl text-gray-800 mx-auto pt-20 p-5 xl:px-0">
            <div className="flex flex-col lg:flex-row gap-5">
                ...
                <div className="flex-1 flex relative justify-center gap-3 sm:gap-5">
                    <div className="h-64 md:h-80  w-40 rounded-md">
                        <img src="https://images.unsplash.com/photo-1584982751601-97dcc096659c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1172&q=80" className="h-full w-full object-cover mt-5 rounded-md" />
                    </div>
                    <div className="h-64 md:h-80 mt-44 w-40 rounded-md">
                        <img src="https://images.pexels.com/photos/5699519/pexels-photo-5699519.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" className="h-full w-full object-cover rounded-md" />
                    </div>
                    <div className="h-64 md:h-80 mt-20 w-40 rounded-md">
