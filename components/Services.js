    ...
    return (
        <div className="max-w-screen-xl text-gray-800 mx-auto py-20 sm:py-40 p-5 xl:px-0">
            <div className="max-w-2xl mx-auto flex flex-col items-center">
                ...
                <button className="text-white mt-5 bg-green-500 rounded-full p-3 px-6 hover:scale-105 transform active:scale-95">Book Now</button>
            </div> 
            <div className="pt-20 relative">
                <div className="w-full md:w-4/6 h-80 md:h-96 lg:h-[500px] rounded-md mx-auto relative">
                    ...
                    <div className="h-14 w-14 sm:h-16 sm:w-16 absolute bottom-8 sm:bottom-5 -left-4 rounded-md bg-white shadow-2xl border-4 border-white">
